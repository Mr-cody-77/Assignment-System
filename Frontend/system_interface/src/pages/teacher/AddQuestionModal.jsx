...
const AddQuestionModal = ({ testId, onClose, onUpdate }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await createAssignment(cleanedData);
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      ...
      >
        <h2 style={{ fontSize: '20px', fontWeight: 'bold', marginBottom: '20px' }}>Add New Question</h2>
          ...
          <div style={{ marginTop: '20px', marginBottom: '24px', padding: '16px', backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: '8px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
              ...
              <p style={{ margin: 0, color: '#aaa', fontSize: '14px' }}>
                {q.hidden_test_cases.length} hidden test case(s) currently attached.
              </p>
            </div>
